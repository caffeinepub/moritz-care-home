...
export default function AddResidentDialog({
  ...
  const resetForm = () => {
    ...
    setMedicaidNumber("");
    setMedicareNumber("");
    setPhysicians([emptyPhysician()]);
    setResponsiblePersons([emptyResponsiblePerson()]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addResident(
      ...
      },
      {
        ...
        onError: (err) => {
          toast.error(
            err instanceof Error ? err.message : "Failed to add resident.",
          );
        },
      },
    );
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                onClick={() => setPhysicians([...physicians, emptyPhysician()])}
              >
            ...
            {medications.map((m, i) => (
              ...
              >
                ...
                <Input
                  ...
                  value={m.administrationTimes}
                  onChange={(e) =>
                    setMedications(
                      medications.map((x, j) =>
                        j === i
                          ? { ...x, administrationTimes: e.target.value }
                          : x,
                      ),
                    )
                  }
