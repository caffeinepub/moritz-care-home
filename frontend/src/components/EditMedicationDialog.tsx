...
export default function EditMedicationDialog({ resident, medication, children }: EditMedicationDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label>Dosage *</Label>
            <Input value={dosage} onChange={(e) => setDosage(e.target.value)} className="bg-white" />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input value={dosageQuantity} onChange={(e) => setDosageQuantity(e.target.value)} className="bg-white" />
          </div>
          <div className="space-y-2">
            <Label>Status</Label>
          ...
          <div className="space-y-2">
            <Label>Notes</Label>
            <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} className="bg-white" rows={3} />
          </div>
          <DialogFooter>
